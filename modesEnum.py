...
class Modes(enum.Enum):
    ...
    unifromMagnitudeAndPhase ="unifromtestMagAndPhaseMode"
    magnitudeAndUnifromPhase="testMagAndUnifromPhaseMode"
    unifromMagnitudeAndUnifromPhase="UtestMagAndUPhaseMode"
# How to use enum?
